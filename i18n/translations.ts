...
export const translations = {
    en: {
        ...
        lmTemperatureTooltip: 'Higher temperature = more random word choices.',
        lmGuidanceScaleTooltip: 'How closely the lyrics model follows the prompt.',
        lmTopKTooltip: 'Restricts choices to the K most likely tokens. 0 disables.',
        lmTopPTooltip: 'Samples from the smallest set whose total probability is P.',
        ...
        lmParametersTooltip: 'Controls the 5Hz lyrics/caption model sampling behavior.',
        lmNegativePromptTooltip: 'Words or ideas to steer the lyrics model away from.',
