...
export const translations = {
    en: {
        ...
        titleTooltip: 'Give your track a name. Optional but helps organize your library.',
        vocalLanguageTooltip: 'Language for generated vocals. Affects pronunciation and phrasing.',
        vocalGenderTooltip: 'Hint the model toward a male or female vocal character.',
        instrumentalTooltip: 'Generate music without vocals.',
        durationTooltip: 'Target length in seconds. Auto lets the model decide based on content.',
        bpmTooltip: 'Beats per minute. Auto lets the model choose based on style.',
        ...
        repaintSettings: 'Repaint Settings',
        audioCoverStrengthHelp: 'How closely the output follows the source audio. Lower = more creative freedom, 1.0 = most faithful.',
        repaintingStartHelp: 'Timestamp (in seconds) where repainting begins.',
        repaintingEndHelp: 'Timestamp (in seconds) where repainting ends. -1 = end of track.',
        beginning: 'Beginning',
        endOfTrack: 'End of track',
        coverNoiseStrength: 'Cover Noise Strength',
        coverNoiseStrengthHelp: 'Melody retention in cover mode. 0 = pure noise, 1 = closest to source. Recommended 0.1–0.25 with SFT model.',
        coverNoiseStrengthTooltip: 'Controls how much of the original audio\'s melody is preserved during cover generation',
        autoMaster: 'Auto-Master',
        autoMasterHelp: 'Apply learned mastering profile (EQ, compression, stereo, loudness). Matches professional Ozone processing.',
        autoMasterTooltip: 'Automatically master output audio using a learned Ozone profile',
        enableNormalization: 'Normalize Audio',
        enableNormalizationHelp: 'Normalize volume to target peak level. Prevents clipping and ensures consistent loudness.',
        enableNormalizationTooltip: 'Apply loudness normalization to the output audio',
        normalizationDb: 'Normalization dB',
        normalizationDbHelp: 'Target peak level in dB. -1.0 dB is a safe default.',
        normalizationDbTooltip: 'Target peak level for audio normalization',
        latentShift: 'Latent Shift',
        latentShiftHelp: 'Additive shift on DiT latents before VAE decode. Negative values (e.g. -0.04) can reduce clipping.',
        latentShiftTooltip: 'Shift applied to internal audio representation before decoding',
        latentRescale: 'Latent Rescale',
        latentRescaleHelp: 'Scale factor for DiT latents before VAE decode. Values < 1.0 (e.g. 0.91) can reduce clipping.',
        latentRescaleTooltip: 'Rescale factor for internal audio representation before decoding',
        outputProcessing: 'Output Processing',
        tempoScale: 'Tempo Scale',
        tempoScaleHelp: 'Pitch-preserving speed change for source audio. 1.0 = original speed, >1 = faster, <1 = slower.',
        tempoScaleTooltip: 'Time-stretch the source audio before cover generation to change tempo without affecting pitch',
        pitchShift: 'Pitch Shift',
        pitchShiftHelp: 'Shift source audio pitch by semitones. +N = higher (e.g. male→female range), -N = lower.',
        pitchShiftTooltip: 'Shift the pitch of the source audio by semitones before cover generation',
        analyzeSource: 'Analyze Source Audio',
        analyzing: 'Analyzing...',
        detectedFromSource: 'Detected from source',
        detectedOverrideWarning: 'Detected from source audio — overriding may cause issues',
        outputBpm: 'Output',
        outputKey: 'Key',
        ...
        higherMoreRandom: 'Controls randomness of audio code generation. Low (0.5) = conservative and predictable, high (1.5+) = creative but risky.',
        lmCfgScale: 'LM CFG Scale',
        noCfgScale: 'Amplifies prompt adherence. 1.0 = raw output, 2.0+ = stronger style/genre following. Works even without a negative prompt.',
        topK: 'Top-K',
        topP: 'Top-P',
        lmNegativePrompt: 'LM Negative Prompt',
        noUserInput: 'NO USER INPUT',
        thingsToAvoid: 'Things to avoid...',
        useWhenCfgScaleGreater: 'Optional: steers the model away from specific qualities. Only active when CFG Scale > 1.0. Leave empty to use a blank baseline.',
        lmTopK: 'LM Top-K',
        lmTopP: 'LM Top-P',
        lmRepetitionPenalty: 'Melodic Variation',
        lmRepetitionPenaltyHelp: 'Penalises repeated audio code tokens. 1.0 = off, 1.1-1.2 = subtle variation, 1.3+ = strong anti-repetition. Helps avoid looping melodies.',
        lmRepetitionPenaltyTooltip: 'Applied during 5Hz LM generation to discourage the model from repeating the same audio code patterns. Higher values force the model to choose less-visited tokens, producing more varied and interesting melodies at the cost of potential incoherence above 1.4.',
        ...
        constrainedDecodingDebugHelp: 'Log debug info during token generation. No effect on output.',
        formatCaptionHelp: 'Auto-rewrite your caption into the structured format the model expects.',
        ...
        solverEuler: 'Euler (1st order, fast)',
        ...
        schedulerDdimDesc: 'Log-SNR uniform (S-curve). Dense around t=0.5, balanced structure and detail.',
        schedulerSgmDesc: 'Karras σ-ramp (ρ=7). Moderate front-loading for structural focus without starving detail.',
        ...
        schedulerCompositeDesc: 'Two-stage: use different schedulers for structure (high noise) and detail (low noise) phases.',
        schedulerTooltip: 'How diffusion timesteps are distributed. All schedulers compose with the Shift slider.',
        compositeStageA: 'Stage A (Structure)',
        compositeStageB: 'Stage B (Detail)',
        compositeCrossover: 'Crossover',
        compositeCrossoverDesc: 'Timestep value (0-1) where Stage A ends and Stage B begins. Lower = more time in structure phase.',
        compositeSplit: 'Step Split',
        compositeSplitDesc: 'Fraction of total steps allocated to Stage A (structure). 0.5 = equal split.',
        ...
        guidanceApg: 'APG — Smooth, perpendicular momentum',
        guidanceAdg: 'ADG — Angle-based, sharper details',
        guidancePag: 'PAG — Perturbed attention',
        guidanceCfg: 'CFG — Standard classifier-free',
        guidanceCfgPp: 'CFG++ — Optimized for few steps',
        guidanceDynamic: 'Dynamic — Decaying guidance schedule',
        guidanceRescaled: 'Rescaled — Prevents over-saturation',
        guidanceSettings: 'Guidance Settings',
        guidanceApgDesc: 'Perpendicular guidance with momentum smoothing. Most balanced — recommended default.',
        guidanceAdgDesc: 'Dynamically adjusts guidance based on the angle between predictions. Try for covers.',
        guidancePagDesc: 'Perturbs attention layers for alternative guidance. Experimental.',
        guidanceCfgDesc: 'Classic classifier-free guidance. Simple and predictable.',
        guidanceCfgPpDesc: 'Scales correction by step size. Better for few-step inference (4-8 steps).',
        guidanceDynamicDesc: 'Full guidance early (structure), low guidance later (detail). Reduces over-saturation.',
        guidanceRescaledDesc: 'Normalizes output to prevent artifacts at high guidance scales (>10).',
        cfgIntervalHelp: 'Which portion of the diffusion process receives guidance. Default 0→1 = throughout.',
        apgHint: 'Smoother results with momentum',
        adgHint: 'Experimental: may produce sharper details',
        pagHint: 'Perturbed-attention guidance with configurable interval',
        // Tooltips
        batchSizeTooltip: 'Create multiple variations in a single run. More variations = longer total time.',
        inferenceStepsTooltip: 'More steps = higher quality but slower generation.',
        guidanceScaleTooltip: 'How closely the model follows your prompt. Higher = stricter, Lower = more creative.',
        shiftTooltip: 'Adjusts the diffusion schedule. Only affects base models.',
        lmTemperatureTooltip: 'Controls the randomness of the 5Hz audio code language model. At 0, the model always picks the single most likely token (deterministic). At 1.0, tokens are sampled proportionally to their probability. Above 1.0, unlikely tokens become more probable — good for diversity but can cause incoherence above 1.5.',
        lmGuidanceScaleTooltip: 'Classifier-Free Guidance for the LM. At 1.0, no guidance is applied (raw sampling). Above 1.0, the model amplifies the difference between your prompt and an empty/negative prompt, pushing harder toward your described style. 2.0-2.5 is recommended for noticeable CoT influence. Does NOT require a negative prompt — it works against a blank baseline by default.',
        lmTopKTooltip: 'Limits sampling to the K most probable tokens at each step. 0 = no limit (all tokens eligible). Lower values (10-30) make output more predictable and safe. Auto uses the model default. Interacts with Top-P — both are applied.',
        lmTopPTooltip: 'Nucleus sampling: only considers the smallest set of tokens whose cumulative probability reaches P. 0.92 = ignore tokens that collectively make up the bottom 8% of probability. Lower values = safer, more focused output. Higher = more diversity but risk of incoherence.',
        useAdgTooltip: 'Adaptive Dual Guidance: dynamically adjusts CFG for quality. Base model only; slower.',
        allowLmBatchTooltip: 'Allows the LM to run in larger batches for speed (more VRAM).',
        useCotMetadataTooltip: 'Let the LM reason about metadata like BPM, key, and length.',
        useCotCaptionTooltip: 'Let the LM reason about the caption/style text.',
        useCotLanguageTooltip: 'Let the LM reason about vocal language selection.',
        constrainedDecodingDebugTooltip: 'Include constrained decoding debug info.',
        formatCaptionTooltip: 'Use the formatted caption from the AI formatter.',
        getScoresTooltip: 'Return the scorer output for diagnostics.',
        getLrcTooltip: 'Return synced lyrics (LRC) output if available.',
        inferMethodTooltip: 'Euler: 1st order, fastest. Heun: 2nd order, more accurate but 2× cost. DPM++ 2M: 2nd order using velocity history, no extra cost. RK4: 4th order, highest precision but 4× cost.',
        seedTooltip: 'Fix the seed for reproducible results. Random recommended for diversity.',
        thinkingTooltip: 'Let the lyrics model reason about structure and metadata. Slightly slower.',
        lmParametersTooltip: 'These parameters control how the 5Hz audio code language model generates tokens. They affect creativity, coherence, and prompt adherence of the CoT (thinking) output. Only active when Thinking (CoT) is enabled.',
        lmNegativePromptTooltip: 'When CFG Scale > 1.0, this replaces the default empty baseline used for guidance. The model will steer away from whatever you describe here. Example: "monotone, flat, generic" to push toward more expressive output. Leave empty to use the default blank-prompt baseline.',
        transformTooltip: 'Controls how closely the output follows the input audio.',
        audioCodesTooltip: 'Advanced: pre-computed audio codes for conditioning.',
        ...
        repaintingStartTooltip: 'Start time (seconds) for the repainting region.',
        repaintingEndTooltip: 'End time (seconds) for the repainting region.',
        instructionTooltip: 'Additional instruction to guide the generation.',
        cfgIntervalStartTooltip: 'Proportion of the diffusion process to start applying guidance.',
        cfgIntervalEndTooltip: 'Proportion of the diffusion process to stop applying guidance.',
        ...
        taskDescText2music: 'Generate music from text descriptions — style, lyrics, and mood.',
        taskDescCover: 'Transform an existing track into a new version using source audio as a guide.',
        taskDescRepaint: 'Selectively regenerate a section of your audio while keeping the rest intact.',
        taskDescExtract: 'Isolate individual instrument or vocal stems from a mixed audio file.',
        taskDescLego: 'Add or overlay a new instrument stem onto existing source audio.',
        taskDescComplete: 'Automatically complete a partial track by generating the missing parts.',
        taskDescAudio2audio: 'Generate new music guided by both text and a reference audio file.',
        extractTrack: 'Extract Track',
        extractTrackTooltip: 'Select which instrument or vocal stem to isolate from the source audio.',
        extractRequiresBaseModel: 'Extract requires a base model (not turbo/SFT).',
        trackVocals: 'Vocals',
        trackBackingVocals: 'Backing Vocals',
        trackDrums: 'Drums',
        trackBass: 'Bass',
        trackGuitar: 'Guitar',
        trackKeyboard: 'Keyboard',
        trackStrings: 'Strings',
        trackSynth: 'Synth',
        trackBrass: 'Brass',
        trackWoodwinds: 'Woodwinds',
        ...
        deleteAllTracksConfirm: 'Are you sure you want to delete all {count} tracks? This will permanently remove all audio files and cannot be undone.',
        allTracksDeleted: 'All tracks deleted',
        deleteAllFailed: 'Failed to delete tracks',
    ...
    zh: {
        ...
        trackDetails: '曲目详情',
        titleTooltip: '为你的曲目命名。可选，但有助于整理你的音乐库。',
        vocalLanguageTooltip: '生成人声的语言。影响发音和措辞。',
        vocalGenderTooltip: '提示模型生成男声或女声。',
        instrumentalTooltip: '生成无人声的纯音乐。',
        durationTooltip: '目标时长（秒）。自动模式让模型根据内容决定。',
        bpmTooltip: '每分钟节拍数。自动模式让模型根据风格选择。',
        ...
        coverSettings: '翻唱设置',
        repaintSettings: '重绘设置',
        audioCoverStrengthHelp: '输出与源音频的匹配程度。较低 = 更自由创作，1.0 = 最忠实于源。',
        repaintingStartHelp: '重绘开始的时间戳（秒）。',
        repaintingEndHelp: '重绘结束的时间戳（秒）。-1 = 音轨结尾。',
        beginning: '开始',
        endOfTrack: '音轨结尾',
        coverNoiseStrength: '翻唱噪声强度',
        coverNoiseStrengthHelp: '翻唱模式下的旋律保留程度。0 = 纯噪声，1 = 最接近原始。推荐使用SFT模型，值设为0.1–0.25。',
        coverNoiseStrengthTooltip: '控制翻唱生成时保留多少原始旋律',
        autoMaster: '自动母带',
        autoMasterHelp: '应用学习的母带配置文件（均衡器、压缩、立体声、响度）。匹配专业Ozone处理效果。',
        autoMasterTooltip: '使用学习的Ozone配置文件自动母带处理输出音频',
        enableNormalization: '音频归一化',
        enableNormalizationHelp: '将音量归一化到目标峰值，防止削波并确保一致的响度。',
        enableNormalizationTooltip: '对输出音频应用响度归一化',
        normalizationDb: '归一化 dB',
        normalizationDbHelp: '目标峰值电平（dB）。-1.0 dB 是安全的默认值。',
        normalizationDbTooltip: '音频归一化的目标峰值电平',
        latentShift: '潜变量偏移',
        latentShiftHelp: 'VAE解码前对DiT潜变量施加的偏移。负值（如-0.04）可减少爆音。',
        latentShiftTooltip: '解码前应用于内部音频表示的偏移',
        latentRescale: '潜变量缩放',
        latentRescaleHelp: 'VAE解码前对DiT潜变量施加的缩放因子。小于1.0的值（如0.91）可减少爆音。',
        latentRescaleTooltip: '解码前应用于内部音频表示的缩放因子',
        ...
        constrainedDecodingDebugHelp: '在令牌生成时记录调试信息。不影响输出。',
        formatCaptionHelp: '自动将描述改写为模型期望的结构化格式。',
        formatCaption: '格式化字幕',
        getScores: '获取分数',
        ...
        solverEuler: 'Euler（1阶，快速）',
        solverHeun: 'Heun（2阶，2倍耗时）',
        solverDpm2m: 'DPM++ 2M（2阶，同耗时）',
        solverRk4: 'RK4（4阶，4倍耗时）',
        guidanceMode: '引导模式',
        guidanceModeTooltip: 'APG: 垂直引导+动量（默认）。ADG: 角度动态。PAG: 扰动注意力。CFG: 标准无分类器。CFG++: 少步优化。Dynamic: 衰减引导。Rescaled: 防过饱和。',
        guidanceApg: 'APG — 平滑，垂直动量引导',
        guidanceAdg: 'ADG — 角度动态，更锐利',
        guidancePag: 'PAG — 扰动注意力',
        guidanceCfg: 'CFG — 标准无分类器引导',
        guidanceCfgPp: 'CFG++ — 少步优化',
        guidanceDynamic: 'Dynamic — 衰减引导计划',
        guidanceRescaled: 'Rescaled — 防止过饱和',
        guidanceSettings: '引导设置',
        guidanceApgDesc: '垂直引导与动量平滑。最平衡——推荐默认值。',
        guidanceAdgDesc: '基于预测角度动态调整引导强度。适合翻唱。',
        guidancePagDesc: '扰动注意力层进行引导。实验性功能。',
        guidanceCfgDesc: '经典无分类器引导。简单可预测。',
        guidanceCfgPpDesc: '按步长缩放校正。更适合少步推理（4-8步）。',
        guidanceDynamicDesc: '前期完整引导（结构），后期减弱（细节）。减少过饱和。',
        guidanceRescaledDesc: '标准化输出，防止高引导值（>10）时产生伪影。',
        cfgIntervalHelp: '扩散过程中哪个部分接收引导。默认 0→1 = 全程。',
        apgHint: '更平滑的结果',
        adgHint: '实验性：可能产生更锐利的细节',
        pagHint: '扰动注意力引导，可配置区间',
        min: '分钟',
        ...
        legoTask: '组合',
        completeTask: '补全',
        requiresBaseModel: '需要基础模型',
        taskDescText2music: '根据文字描述生成音乐——风格、歌词和情绪。',
        taskDescCover: '使用源音频作为参考，将现有曲目转化为新版本。',
        taskDescRepaint: '选择性地重新生成音频的某个片段，同时保留其余部分。',
        taskDescExtract: '从混合音频中分离单独的乐器或人声音轨。',
        taskDescLego: '在现有源音频上添加或叠加新的乐器音轨。',
        taskDescComplete: '自动补全不完整的音轨，生成缺失的部分。',
        taskDescAudio2audio: '通过文字和参考音频共同引导生成新音乐。',
        extractTrack: '提取音轨',
        extractTrackTooltip: '选择要从源音频中分离的乐器或人声。',
        extractRequiresBaseModel: '提取功能需要基础模型（非turbo/SFT）。',
        trackVocals: '人声',
        trackBackingVocals: '和声',
        trackDrums: '鼓',
        trackBass: '贝斯',
        trackGuitar: '吉他',
        trackKeyboard: '键盘',
        ...
        deleteAllTracks: '删除所有曲目',
        deleteAllTracksConfirm: '确定要删除所有 {count} 首曲目吗？这将永久删除所有音频文件，且无法撤销。',
        allTracksDeleted: '所有曲目已删除',
        deleteAllFailed: '删除曲目失败',
    ...
    ja: {
        ...
        trackDetails: 'トラック詳細',
        titleTooltip: 'トラックに名前を付けます。任意ですが、ライブラリの整理に役立ちます。',
        vocalLanguageTooltip: '生成されるボーカルの言語。発音とフレージングに影響します。',
        vocalGenderTooltip: 'モデルに男性または女性のボーカルを示唆します。',
        instrumentalTooltip: 'ボーカルなしの音楽を生成します。',
        durationTooltip: '目標の長さ（秒）。Autoでモデルがコンテンツに基づいて決定します。',
        ...
        coverSettings: 'カバー設定',
        repaintSettings: 'リペイント設定',
        audioCoverStrengthHelp: '出力がソース音声にどれだけ従うか。低い = より自由、1.0 = 最も忠実。',
        repaintingStartHelp: 'リペイント開始のタイムスタンプ（秒）。',
        repaintingEndHelp: 'リペイント終了のタイムスタンプ（秒）。-1 = トラック終了。',
        beginning: '開始',
        endOfTrack: 'トラック終了',
        coverNoiseStrength: 'カバーノイズ強度',
        coverNoiseStrengthHelp: 'カバーモードでのメロディ保持度。0 = 純ノイズ、1 = 原音に最も近い。SFTモデルで0.1–0.25推奨。',
        coverNoiseStrengthTooltip: 'カバー生成時の原曲メロディの保持度を制御',
        autoMaster: 'オートマスター',
        autoMasterHelp: '学習済みマスタリングプロファイル（EQ、コンプ、ステレオ、ラウドネス）を適用。プロのOzone処理に匹敵。',
        autoMasterTooltip: '学習済みOzoneプロファイルで出力音声を自動マスタリング',
        enableNormalization: '音声正規化',
        enableNormalizationHelp: '音量をターゲットピークに正規化。クリッピング防止と一定の音量を確保。',
        enableNormalizationTooltip: '出力音声にラウドネス正規化を適用',
        normalizationDb: '正規化 dB',
        normalizationDbHelp: 'ターゲットピークレベル（dB）。-1.0 dBが安全なデフォルト。',
        normalizationDbTooltip: '音声正規化のターゲットピークレベル',
        latentShift: '潜在シフト',
        latentShiftHelp: 'VAEデコード前のDiT潜在変数へのシフト。負の値（例：-0.04）でクリッピング軽減。',
        latentShiftTooltip: 'デコード前の内部音声表現へのシフト',
        latentRescale: '潜在リスケール',
        latentRescaleHelp: 'VAEデコード前のDiT潜在変数のスケール係数。1.0未満の値（例：0.91）でクリッピング軽減。',
        latentRescaleTooltip: 'デコード前の内部音声表現のスケール係数',
        ...
        constrainedDecodingDebugHelp: 'トークン生成時にデバッグ情報を記録。出力に影響なし。',
        formatCaptionHelp: 'モデルが期待する構造化形式にキャプションを自動書き換え。',
        ...
        solverEuler: 'Euler（1次、高速）',
        solverHeun: 'Heun（2次、2倍コスト）',
        solverDpm2m: 'DPM++ 2M（2次、同コスト）',
        solverRk4: 'RK4（4次、4倍コスト）',
        guidanceMode: 'ガイダンスモード',
        guidanceModeTooltip: 'APG: 垂直ガイダンス+モメンタム（デフォルト）。ADG: 角度ベース。PAG: 摂動アテンション。CFG: 標準。CFG++: 少ステップ最適化。Dynamic: 減衰スケジュール。Rescaled: 過飽和防止。',
        guidanceApg: 'APG — スムーズ、垂直モメンタム',
        guidanceAdg: 'ADG — 角度ベース、鮮明',
        guidancePag: 'PAG — 摂動アテンション',
        guidanceCfg: 'CFG — 標準分類器フリー',
        guidanceCfgPp: 'CFG++ — 少ステップ最適化',
        guidanceDynamic: 'Dynamic — 減衰ガイダンス',
        guidanceRescaled: 'Rescaled — 過飽和防止',
        guidanceSettings: 'ガイダンス設定',
        guidanceApgDesc: '垂直ガイダンスとモメンタム平滑。最もバランスが良い—推奨デフォルト。',
        guidanceAdgDesc: '予測間の角度に基づいて動的に調整。カバーに適しています。',
        guidancePagDesc: 'アテンション層を摂動させるガイダンス。実験的。',
        guidanceCfgDesc: '標準的なクラシファイアフリーガイダンス。シンプルで予測可能。',
        guidanceCfgPpDesc: 'ステップサイズに応じて補正をスケール。少ステップ推論（4-8ステップ）に最適。',
        guidanceDynamicDesc: '前半は完全ガイダンス（構造）、後半は低ガイダンス（ディテール）。過飽和を軽減。',
        guidanceRescaledDesc: '高ガイダンススケール（>10）でのアーティファクトを防ぐため出力を正規化。',
        cfgIntervalHelp: '拡散プロセスのどの部分がガイダンスを受けるか。デフォルト 0→1 = 全体。',
        apgHint: 'よりスムーズな結果',
        adgHint: '実験的: より鮮明なディテール',
        pagHint: '摂動アテンションガイダンス、設定可能な区間',
        min: '分',
        ...
        legoTask: 'レゴ',
        completeTask: '補完',
        requiresBaseModel: 'ベースモデルが必要',
        taskDescText2music: 'テキスト説明から音楽を生成——スタイル、歌詞、雰囲気。',
        taskDescCover: 'ソースオーディオをガイドにして、既存のトラックを新しいバージョンに変換します。',
        taskDescRepaint: 'オーディオの一部を選択的に再生成し、残りはそのまま保持します。',
        taskDescExtract: 'ミックスオーディオから個々の楽器やボーカルステムを分離します。',
        taskDescLego: '既存のソースオーディオに新しい楽器ステムを追加または重ねます。',
        taskDescComplete: '不完全なトラックの欠落部分を自動的に生成して補完します。',
        taskDescAudio2audio: 'テキストと参照オーディオの両方でガイドされた新しい音楽を生成します。',
        extractTrack: 'トラック抽出',
        extractTrackTooltip: 'ソースオーディオから分離する楽器またはボーカルを選択します。',
        extractRequiresBaseModel: '抽出にはベースモデルが必要です（turbo/SFTは非対応）。',
        trackVocals: 'ボーカル',
        trackBackingVocals: 'バックボーカル',
        trackDrums: 'ドラム',
        trackBass: 'ベース',
        trackGuitar: 'ギター',
        trackKeyboard: 'キーボード',
        ...
        extractStems: 'ステムを抽出',
        enhanceAudio: 'オーディオを強化',
        upscaleToHQ: '高品質にアップスケール',
        ...
        deleteAllTracks: '全曲を削除',
        deleteAllTracksConfirm: '全{count}曲を削除しますか？全ての音楽ファイルが完全に削除され、元に戻すことはできません。',
        allTracksDeleted: '全曲を削除しました',
        deleteAllFailed: '曲の削除に失敗しました',
    ...
    ko: {
        ...
        trackDetails: '트랙 세부정보',
        titleTooltip: '트랙에 이름을 지정합니다. 선택사항이지만 라이브러리 정리에 도움됩니다.',
        vocalLanguageTooltip: '생성되는 보컬의 언어. 발음과 프레이징에 영향을 줍니다.',
        vocalGenderTooltip: '남성 또는 여성 보컬 캐릭터를 모델에 힌트합니다.',
        instrumentalTooltip: '보컬 없이 음악을 생성합니다.',
        durationTooltip: '목표 길이(초). Auto는 모델이 내용에 따라 결정합니다.',
        bpmTooltip: '분당 비트 수. Auto는 모델이 스타일에 따라 선택합니다.',
        ...
        coverSettings: '커버 설정',
        repaintSettings: '리페인트 설정',
        audioCoverStrengthHelp: '출력이 소스 오디오를 얼마나 따르는지. 낮음 = 더 창의적, 1.0 = 가장 충실.',
        repaintingStartHelp: '리페인트 시작 타임스탬프 (초).',
        repaintingEndHelp: '리페인트 종료 타임스탬프 (초). -1 = 트랙 끝.',
        beginning: '시작',
        endOfTrack: '트랙 끝',
        coverNoiseStrength: '커버 노이즈 강도',
        coverNoiseStrengthHelp: '커버 모드에서 멜로디 보존 정도. 0 = 순수 노이즈, 1 = 원본에 가장 가까움. SFT 모델에서 0.1–0.25 권장.',
        coverNoiseStrengthTooltip: '커버 생성 시 원곡 멜로디의 보존 정도를 제어',
        autoMaster: '자동 마스터링',
        autoMasterHelp: '학습된 마스터링 프로파일(EQ, 압축, 스테레오, 라우드니스) 적용. 전문 Ozone 처리와 동일.',
        autoMasterTooltip: '학습된 Ozone 프로파일로 출력 오디오 자동 마스터링',
        enableNormalization: '오디오 정규화',
        enableNormalizationHelp: '볼륨을 목표 피크 레벨로 정규화. 클리핑 방지 및 일관된 음량 보장.',
        enableNormalizationTooltip: '출력 오디오에 라우드니스 정규화 적용',
        normalizationDb: '정규화 dB',
        normalizationDbHelp: '목표 피크 레벨(dB). -1.0 dB이 안전한 기본값.',
        normalizationDbTooltip: '오디오 정규화의 목표 피크 레벨',
        latentShift: '잠재 시프트',
        latentShiftHelp: 'VAE 디코딩 전 DiT 잠재 변수에 적용할 시프트. 음수 값(예: -0.04)으로 클리핑 감소.',
        latentShiftTooltip: '디코딩 전 내부 오디오 표현에 적용되는 시프트',
        latentRescale: '잠재 리스케일',
        latentRescaleHelp: 'VAE 디코딩 전 DiT 잠재 변수의 스케일 팩터. 1.0 미만(예: 0.91)으로 클리핑 감소.',
        latentRescaleTooltip: '디코딩 전 내부 오디오 표현의 스케일 팩터',
        outputProcessing: '출력 처리',
        ...
        constrainedDecodingDebugHelp: '토큰 생성 시 디버그 정보 기록. 출력에 영향 없음.',
        formatCaptionHelp: '모델이 기대하는 구조화된 형식으로 캡션을 자동 재작성.',
        formatCaption: '캡션 포맷',
        getScores: '점수 가져오기',
        ...
        solverEuler: 'Euler (1차, 빠름)',
        solverHeun: 'Heun (2차, 2배 비용)',
        solverDpm2m: 'DPM++ 2M (2차, 동일 비용)',
        solverRk4: 'RK4 (4차, 4배 비용)',
        guidanceMode: '가이던스 모드',
        guidanceModeTooltip: 'APG: 수직 가이던스+모멘텀 (기본). ADG: 각도 기반. PAG: 섭동 어텐션. CFG: 표준. CFG++: 소수 스텝 최적화. Dynamic: 감쇠 스케줄. Rescaled: 과포화 방지.',
        guidanceApg: 'APG — 부드러움, 수직 모멘텀',
        guidanceAdg: 'ADG — 각도 기반, 선명',
        guidancePag: 'PAG — 섭동 어텐션',
        guidanceCfg: 'CFG — 표준 분류기 프리',
        guidanceCfgPp: 'CFG++ — 소수 스텝 최적화',
        guidanceDynamic: 'Dynamic — 감쇠 가이던스',
        guidanceRescaled: 'Rescaled — 과포화 방지',
        guidanceSettings: '가이던스 설정',
        guidanceApgDesc: '수직 가이던스와 모멘텀 스무딩. 가장 균형 잡힌—권장 기본값.',
        guidanceAdgDesc: '예측 간 각도에 따라 동적으로 조정. 커버에 적합.',
        guidancePagDesc: '어텐션 레이어를 교란하는 가이던스. 실험적.',
        guidanceCfgDesc: '표준 분류기 프리 가이던스. 간단하고 예측 가능.',
        guidanceCfgPpDesc: '스텝 크기에 따라 보정 스케일링. 소수 스텝 추론(4-8 스텝)에 적합.',
        guidanceDynamicDesc: '초반 완전 가이던스(구조), 후반 낮은 가이던스(디테일). 과포화 감소.',
        guidanceRescaledDesc: '높은 가이던스 스케일(>10)에서 아티팩트를 방지하기 위해 출력 정규화.',
        cfgIntervalHelp: '확산 프로세스의 어느 부분이 가이던스를 받는지. 기본값 0→1 = 전체.',
        apgHint: '더 부드러운 결과',
        adgHint: '실험적: 더 선명한 디테일',
        pagHint: '섭동 어텐션 가이던스, 설정 가능한 구간',
        min: '분',
        ...
        legoTask: '레고',
        completeTask: '보완',
        requiresBaseModel: '기본 모델 필요',
        taskDescText2music: '텍스트 설명으로 음악을 생성합니다 — 스타일, 가사, 분위기.',
        taskDescCover: '소스 오디오를 가이드로 사용하여 기존 트랙을 새 버전으로 변환합니다.',
        taskDescRepaint: '오디오의 일부를 선택적으로 재생성하고 나머지는 그대로 유지합니다.',
        taskDescExtract: '믹스된 오디오에서 개별 악기 또는 보컬 스템을 분리합니다.',
        taskDescLego: '기존 소스 오디오에 새로운 악기 스템을 추가하거나 겹칩니다.',
        taskDescComplete: '불완전한 트랙의 누락된 부분을 자동으로 생성하여 보완합니다.',
        taskDescAudio2audio: '텍스트와 참조 오디오 모두로 가이드된 새로운 음악을 생성합니다.',
        extractTrack: '트랙 추출',
        extractTrackTooltip: '소스 오디오에서 분리할 악기 또는 보컬을 선택합니다.',
        extractRequiresBaseModel: '추출에는 기본 모델이 필요합니다 (turbo/SFT 미지원).',
        trackVocals: '보컬',
        trackBackingVocals: '백보컬',
        trackDrums: '드럼',
        trackBass: '베이스',
        trackGuitar: '기타',
        trackKeyboard: '키보드',
        ...
        deleteAllTracks: '모든 트랙 삭제',
        deleteAllTracksConfirm: '모든 {count}개의 트랙을 삭제하시겠습니까? 모든 오디오 파일이 영구적으로 삭제되며 되돌릴 수 없습니다.',
        allTracksDeleted: '모든 트랙이 삭제되었습니다',
        deleteAllFailed: '트랙 삭제에 실패했습니다',
