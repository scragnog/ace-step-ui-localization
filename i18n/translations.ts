...
export const translations = {
    en: {
        ...
        autoMasterHelp: 'Apply learned mastering profile (EQ, compression, stereo, loudness) trained from professional reference audio.',
        autoMasterTooltip: 'Automatically master output audio using a learned mastering profile',
    ...
    zh: {
        ...
        autoMaster: '自动母带',
        autoMasterHelp: '应用从专业参考音频学习的母带配置文件（均衡器、压缩、立体声、响度）。',
        autoMasterTooltip: '使用学习的母带配置文件自动处理输出音频',
    ...
    ja: {
        ...
        autoMaster: 'オートマスター',
        autoMasterHelp: 'プロの参照音声から学習したマスタリングプロファイル（EQ、コンプ、ステレオ、ラウドネス）を適用。',
        autoMasterTooltip: '学習済みマスタリングプロファイルで出力音声を自動マスタリング',
    ...
    ko: {
        ...
        autoMaster: '자동 마스터링',
        autoMasterHelp: '전문 참조 오디오에서 학습한 마스터링 프로파일(EQ, 압축, 스테레오, 라우드니스) 적용.',
        autoMasterTooltip: '학습된 마스터링 프로파일로 출력 오디오 자동 마스터링',
